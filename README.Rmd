...
Based on the above, you can see how certain strategies don't really make a difference, and certain ones perform worse. For example the zero-WR strategy (6) performs about 50 points worse than the default strategy. Not taking a backup TE and QB also worsen the score.
