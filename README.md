...
isn’t accounted for in the above link though, is that in reality you are
not trying to maximize projected points of a full draft, but rather for
your eventual starting lineup, so you’re trying to pick the draft that
will give you the best eventual nine players.
...
And there are the detailed parameters with each strategy:
    ...
    ## 4            4     5     4     2     2    1      1           zeroRB R1-3
    ## 5            5     6     3     2     2    1      1 zeroRB R1-3. RB heavy
    ## 6            6     4     5     2     2    1      1           zeroWR R1-3
    ## 7            7     3     6     2     2    1      1 zeroWR R1-3. WR heavy
